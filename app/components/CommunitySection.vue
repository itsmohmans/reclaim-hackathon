...
<template>
  <section id="community" class="py-16 sm:py-24 px-6 sm:px-10">
    <div class="max-w-280 mx-auto">
      <div class="max-w-170 mx-auto text-center">
        ...
        <p
          ...
          :key="i"
          class="text-lg leading-[1.7] text-(--bp-text-secondary) mb-4 last:mb-0"
        >
          {{ para }}
        </p>
      </div>
